class Vlc < Formula
  ...
  def install
    ...
    if MacOS.version >= "10.14"
      ...
      darwin_ver = "x86_64-apple-darwin18"
      ...
      cfl = "CFLAGS=\"-I#{gettext.include}  -mmacosx-version-min=10.6\""
      cxxfl = "CXXFLAGS=\" -mmacosx-version-min=10.6\""
      darwin_ver = "x86_64-apple-darwin17"
      ...
      cfl = "CFLAGS=\"-I#{gettext.include}  -mmacosx-version-min=10.6\""
      cxxfl = "CXXFLAGS=\" -mmacosx-version-min=10.6\""
      darwin_ver = "x86_64-apple-darwin16"
      ...
      cfl = "CFLAGS=\"-I#{gettext.include}  -mmacosx-version-min=10.6\""
      cxxfl = "CXXFLAGS=\" -mmacosx-version-min=10.6\""
      darwin_ver = "x86_64-apple-darwin15"
      ...
      cfl = "CFLAGS=\"-I#{gettext.include}  -mmacosx-version-min=10.6\""
      cxxfl = "CXXFLAGS=\" -mmacosx-version-min=10.6\""
      darwin_ver = "x86_64-apple-darwin14"
    elsif MacOS.version >= "10.9"
      sdk = "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk"
      cfl = "CFLAGS=\"-I#{gettext.include}  -mmacosx-version-min=10.6\""
      cxxfl = "CXXFLAGS=\" -mmacosx-version-min=10.6\""
      darwin_ver = "x86_64-apple-darwin13"
    elsif MacOS.version >= "10.8"
      sdk = "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.8.sdk"
      cfl = "CFLAGS=\"-I#{gettext.include}  -mmacosx-version-min=10.6\""
      cxxfl = "CXXFLAGS=\" -mmacosx-version-min=10.6\""
      darwin_ver = "x86_64-apple-darwin12"
    else
      sdk = "/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.7.sdk"
      cfl = "CFLAGS=\"-I#{gettext.include}  -mmacosx-version-min=10.6\""
      cxxfl = "CXXFLAGS=\" -mmacosx-version-min=10.6\""
      darwin_ver = "x86_64-apple-darwin11"
    end
    ...
    if MacOS.xcode_version.to_f >= 5.0
      ...
      exp = "export #{aclocal}; export #{cc}; export #{cxx}; export #{objc}; export #{ldf}; \
	export #{cfl}; export #{cxxfl}; export SDKROOT=#{sdk}; export #{libt}; \
      	export #{libtfl}; export OSX_VERSION=#{MacOS.version}"
    end

    # Additional Libs
    # KLN 20/08/2012 Added 'make .ogg' and 'make .vorbis' in order to get this recipe to work on OSX 10.6
    system "#{exp}; cd contrib; mkdir -p osx; cd osx; ../bootstrap --host=#{darwin_ver} --build=#{darwin_ver} --disable-sout"
    ...
    # to remove the .git folder create a blank file so that this step passes
    touch "src/revision.txt"

    # VLC
    system "#{exp}; ./bootstrap"
    system "#{exp}; mkdir -p build; cd build; ../extras/package/macosx/configure.sh \
    	--disable-ncurses --disable-asa --disable-macosx --disable-macosx-dialog-provider \
    	--disable-libcddb --disable-cdda --with-macosx-sdk=#{sdk} -host=#{darwin_ver} \
    	--build=#{darwin_ver} --prefix=#{prefix}"
